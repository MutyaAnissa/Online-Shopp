            ...
            <form action="edit_product.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <select class="p-3 border rounded my-1 w-full" id="productCategory" name="productCategory" required>
                        <option value="Fruits" <?php if ($productData['category'] === 'Alat pengukur') echo 'selected'; ?>>Alat pengukur</option>
                        <option value="Vegetables" <?php if ($productData['category'] === 'Alat bantu kesehatan') echo 'selected'; ?>>Alat bantu kesehatan</option>
                    </select>
                </div>
                <div>
