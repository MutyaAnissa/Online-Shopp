...
<body>
    ...
    <main class="min-h-screen m-10 flex flex-col gap-10">
        <div class="text-3xl font-bold capitalize">
            ...
            <p>Pantau kesehatanmu dan orang tersayang di rumah dengan mudah bersama TaffOmicron!</p>
        </div>
        <section class="flex lg:flex-row flex-col-reverse justify-between gap-10">
            ...
            <div class="border-2 rounded-xl p-5 h-full w-full lg:w-[30rem]">
                ...
                <div class="flex flex-col gap-2 transition-all">
                    ...
                    <a href="index.php?category=Alat pengukur" class="<?= $currentCategory === 'Alat pengukur' ? 'bg-black text-white' : '' ?> p-2">Alat pengukur</a>
                    <a href="index.php?category=Alat bantu kesehatan" class="<?= $currentCategory === 'Alat bantu kesehatan' ? 'bg-black text-white' : '' ?> p-2">Alat bantu kesehatan</a>
                </div>
            </div>
        </section>
    </main>
